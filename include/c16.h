/* c16.h --- 16candles basic types and opcodes.
...
typedef uint16_t c16_word;

// The type of a halfword on the 16candles machine.
typedef uint8_t c16_halfword;

// The type of a double word on the 16candles machine.
typedef uint32_t c16_dword;


// Booleans in the 16candles system (instead of stdbool.h).
typedef c16_halfword c16_bool;
#define c16_true  ((c16_bool) 1)
#define c16_false ((c16_bool) 0)
